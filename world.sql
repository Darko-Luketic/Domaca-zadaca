...
select * from country where LocalName ='Hrvatska';
update country set LifeExpectancy=51 where Code2 ='HR';
update country set HeadOfState = 'Darko' where Name ='Croatia';
select * from country where not GovernmentForm  ='Republic';
select * from country where GovernmentForm  ='Monarchy';
update country set HeadOfState ='Git' where GovernmentForm ='Monarchy';
select * from country where LifeExpectancy<=50;
update country set HeadOfState='Treba bolje' where LifeExpectancy<=50;
select * from country where LifeExpectancy<=45;
update country set HeadOfState='nemoj me ...' where LifeExpectancy<=41;
