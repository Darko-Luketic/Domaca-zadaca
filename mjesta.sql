...
update mjesto set naziv='Legograd' where postanskibroj =31000;
select * from mjesto where naziv='Legograd';
select * from mjesto where naziv='Zagreb';
update mjesto set naziv='Purgergrad' where postanskibroj =10000;
